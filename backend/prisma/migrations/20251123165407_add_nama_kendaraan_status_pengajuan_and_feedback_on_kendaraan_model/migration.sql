...
-- AlterTable
ALTER TABLE "kendaraan" ADD COLUMN     "feedback" TEXT,
ADD COLUMN     "nama_kendaraan" VARCHAR(100) NOT NULL DEFAULT 'Motor',
ADD COLUMN     "status_pengajuan" "StatusPengajuan" NOT NULL DEFAULT 'MENUNGGU';

-- CreateIndex
CREATE INDEX "idx_kendaraan_status" ON "kendaraan"("status_pengajuan");
